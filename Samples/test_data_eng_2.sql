...
CREATE TABLE cal
   (weekno  varchar2(1),
    day   varchar2(5),
    dayno varchar2(2)) tablespace example; 
...
( gno  number ,
  gname varchar2(30) ,
  g_start  number ,
  g_end  number ) tablespace example;
...
(grade char(3) ,
 min_point  number ,
 max_point  number )  tablespace example; 
...
( position  varchar2(30) ,
  ...
  e_year number ,
  s_pay  number ,
  e_pay  number ) tablespace example;
...
CREATE TABLE t_reg
( text varchar2(10)) tablespace example;
...
CREATE TABLE p_01
(no  number ,
 name varchar2(15) ) tablespace example;
...
create table pt_01
(sno varchar2(8) , pno char(4) , qty number , price  number) tablespace example;
...
CREATE TABLE t_validate
 ( no number
   ...
   name  varchar2(10)
    CONSTRAINT tv_name_nn NOT NULL) tablespace example;
...
CREATE TABLE t_enable
 ( no number
   ...
   name varchar2(10)
    CONSTRAINT te_name_nn NOT NULL) tablespace example;
...
( p_code  number(3) primary key,
  ...
  p_price  number) tablespace example;
...
( p_date varchar2(8) not null,
  ...
  p_qty  number ,
  p_total number ,
  p_store varchar2(5) ) tablespace example;
...
(no number(4) not null ,
 ...
 an_key varchar2(10) ,
 an_key_dap  varchar2(15) ) tablespace example;
...
create table t_reg2
(no number , 
 ip varchar2(20)) tablespace example;
...
( l_date varchar2(8) not null,
  ...
  l_qty  number ,
  l_total number ,
  l_store varchar2(5) ) tablespace example;
...
CREATE TABLE EMP ( 
  ...
  SAL       NUMBER(7, 2),
  COMM      NUMBER(7, 2), 
  DEPTNO    NUMBER(2, 0)) tablespace example;
...
CREATE TABLE DEPT (
  DEPTNO   NUMBER(2,0), 
  DNAME    VARCHAR2(14), 
  LOC      VARCHAR2(13)) tablespace example;
